...
import { Check, Upload, ArrowLeft, Palette } from "lucide-react";
        ...
        <div className="flex-1 space-y-6 p-8 pt-6 max-w-6xl mx-auto">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-muted-foreground">
                                Passen Sie den Namen und das Branding Ihrer Pension an.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div className="grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                <Card className="col-span-2 shadow-md border-zinc-200 dark:border-zinc-800">
                    <CardHeader>
                        <CardTitle>Branding & Erscheinungsbild</CardTitle>
                        <CardDescription>
